    ...
    if adapter_args.train_adapter:
        ...
        if task_name not in model.config.adapters:
            ...
            if adapter_args.load_adapter:
                pivot_based_stepwise_pre_training_using_adapters_final = adapter_args.load_adapter.split("-")
                if pivot_based_stepwise_pre_training_using_adapters_final[
                    0] == "pivot_based_stepwise_pre_training_using_adapters_final":
                    selected_adapters = pivot_based_stepwise_pre_training_using_adapters_final[1][1:-1].split(",")
        ...
        if pivot_based_stepwise_pre_training_using_adapters_final[0] == "pivot_based_stepwise_pre_training_using_adapters_final":
            pass
        else:
