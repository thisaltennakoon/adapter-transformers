        ...
        if task_name not in model.config.adapters:
            ...
            if adapter_args.load_adapter:
                ...
                if pivot_based_plain_transfer_learning_using_adapters[
                    ...
                    task_name += "_using_" + selected_adapter_for_the_encoder[
                                             -5:] + "&" + selected_adapter_for_the_decoder[-5:]
...
#--model_name_or_path facebook/mbart-large-50 --do_train --do_eval --do_predict --train_file D:\AdapterFusionEnSiFusionhoulsbyUsingAllAdapters\DataSets1\SiTa\parallel-27.04.2021-trUnique56K.si-en-ta.SiTa.json --validation_file D:\AdapterFusionEnSiFusionhoulsbyUsingAllAdapters\DataSets1\SiTa\parallel-27.04.2021-tu.un.si-en-ta.SiTa.json --test_file D:\AdapterFusionEnSiFusionhoulsbyUsingAllAdapters\DataSets1\SiTa\parallel-27.04.2021-ts.un.si-en-ta.SiTa.json --source_lang si_LK --target_lang ta_IN --output_dir D:\pivot_based_plain_transfer_learning_using_adapters\SiTa --per_device_train_batch_size=2 --per_device_eval_batch_size=2 --overwrite_output_dir --predict_with_generate --forced_bos_token ta_IN --save_steps 50000 --num_beams 10 --train_adapter --adapter_config houlsby --adapter_reduction_factor 2 --evaluation_strategy epoch --metric_for_best_model eval_bleu --patience 2 --learning_rate 1e-4 --num_train_epochs 1 --load_adapter pivot_based_plain_transfer_learning_using_adapters-[D:\AdapterFusionEnSiFusionhoulsbyUsingAllAdapters\Adapters\si_en,D:\AdapterFusionEnSiFusionhoulsbyUsingAllAdapters\Adapters\en_ta]